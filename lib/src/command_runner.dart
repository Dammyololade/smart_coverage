...
import 'package:smart_coverage/src/commands/commands.dart';
import 'package:smart_coverage/src/version.dart';
...
/// ```
/// {@endtemplate}
class SmartCoverageCommandRunner extends CompletionCommandRunner<int> {
  /// {@macro smart_coverage_command_runner}
  SmartCoverageCommandRunner({Logger? logger, PubUpdater? pubUpdater})
    ...
    addCommand(CompletionSetupCommand(logger: _logger));

...
import 'package:smart_coverage/src/command_runner.dart';
...
void main() {
  group('SmartCoverageCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late SmartCoverageCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = SmartCoverageCommandRunner(
        logger: logger,
    ...
    test(
      ...
      () {
        final commandRunner = SmartCoverageCommandRunner();
